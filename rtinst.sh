...
while [ $script_size = 0 ]
  do
    ...
    wget --no-check-certificate https://github.com/lordpeppers/rutorrent-script-lordpeppers/$script_name >> $logfile 2>&1
...
if [ $install_rt = 0 ]; then
  ...
  curl -# --connect-timeout 5 http://pkgs.fedoraproject.org/repo/pkgs/libtorrent/libtorrent-0.13.4.tar.gz/e82f380a9d4b55b379e0e73339c73895/libtorrent-0.13.4.tar.gz | tar xz  >> $logfile 2>&1 || curl -# https://codeload.github.com/rakshasa/libtorrent/tar.gz/0.13.4 | tar xz  >> $logfile 2>&1 || error_exit "Unable to download libtorrent source files from http://libtorrent.rakshasa.no/downloads"
  curl -# --connect-timeout 5 http://pkgs.fedoraproject.org/repo/pkgs/rtorrent/rtorrent-0.9.4.tar.gz/fd9490a2ac67d0fa2a567c6267845876/rtorrent-0.9.4.tar.gz | tar xz  >> $logfile 2>&1 || curl -# https://codeload.github.com/rakshasa/rtorrent/tar.gz/0.9.4 | tar xz  >> $logfile 2>&1 || error_exit "Unable to download rtorrent source files from http://libtorrent.rakshasa.no/downloads"
...
#   wget --no-check-certificate https://bintray.com/artifact/download/novik65/generic/rutorrent-3.7.tar.gz >> $logfile 2>&1 || error_exit "Unable to download rutorrent files from https://bintray.com/artifact/download/novik65/generic/rutorrent-3.7.tar.gz"
#   wget --no-check-certificate https://bintray.com/artifact/download/novik65/generic/plugins-3.7.tar.gz >> $logfile 2>&1 || error_exit "Unable to download rutorrent plugin files from https://bintray.com/artifact/download/novik65/generic/plugins-3.7.tar.gz"
#   tar -xzf rutorrent-3.7.tar.gz
#   tar -xzf plugins-3.7.tar.gz
#   rm rutorrent-3.7.tar.gz
#   rm plugins-3.7.tar.gz
